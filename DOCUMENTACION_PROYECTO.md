# Documentación del Proyecto - Machine Learning Aplicado

## Examen Final - Proyecto Integrador

**Fecha de Entrega:** 24 de Noviembre de 2025  
**Modalidad:** Desarrollo + Página Web
...
Este proyecto integrador implementa y compara modelos de Machine Learning supervisado y no supervisado con despliegue en una aplicación web funcional. El objetivo es demostrar la comprensión práctica de algoritmos de ML y su aplicación en problemas reales de negocio.

### Objetivos Cumplidos

✅ Implementación de Regresión Logística para predicción de Churn  
✅ Implementación de K-Nearest Neighbors (KNN) para clasificación de Churn  
✅ Implementación de K-Means para segmentación de clientes  
✅ Comparación de métricas entre modelos supervisados  
✅ Aplicación web funcional con formularios interactivos  
✅ Visualizaciones de métricas y resultados  
...
1. ✅ **Implementación Exitosa de Tres Modelos de ML**
   - Regresión Logística y KNN con métricas comparables
   - K-Means con segmentación significativa

2. ✅ **Aplicación Web Completamente Funcional**
...
4. ✅ **Análisis Comparativo Exhaustivo**
...
1. **Preprocesamiento es Crucial:**
   - La normalización es esencial para KNN
   - El encoding correcto afecta significativamente el desempeño
   - El manejo de valores faltantes impacta el clustering

2. **Selección de Hiperparámetros:**
   - K=15 fue óptimo para KNN en este dataset
   - K=2 clusters dio la mejor separación en segmentación
   - La validación cruzada ayuda a evitar overfitting

3. **Interpretabilidad vs Performance:**
   - Regresión Logística ofrece mejor interpretabilidad
   - KNN es más flexible pero menos interpretable
   - El trade-off depende del caso de uso

4. **Despliegue Web:**
   - FastAPI facilita la creación de APIs ML
   - React permite UIs interactivas y modernas
   - La serialización con Joblib es eficiente
...
2. **Funcionalidades Adicionales:**
   - Carga de archivos CSV para predicción en lote
   - Exportación de resultados a PDF/Excel
   - Dashboard con analytics histórico
...
**Proyecto Final - Machine Learning Aplicado 2025**

---

## 📄 Licencia

Este proyecto fue desarrollado con fines educativos para el examen final de la materia Machine Learning Aplicado.
...
### Datasets
- Telco Customer Churn: Dataset sintético basado en estructura de Kaggle
- Credit Card Dataset: Dataset sintético para clustering
