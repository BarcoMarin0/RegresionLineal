...
- Los datasets son sintéticos, generados para simular los datasets originales de Kaggle
- Los modelos están entrenados con fines educativos
- El código está completamente documentado en español

## 📄 Licencia

Este proyecto fue desarrollado con fines educativos para el examen final.
